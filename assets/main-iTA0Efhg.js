var w=Object.defineProperty;var p=(s,e,t)=>e in s?w(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var i=(s,e,t)=>p(s,typeof e!="symbol"?e+"":e,t);import{f as C,h as f,e as b,E as o,g as x,c as S,j as n,T as l,k,s as L,i as q}from"./rating.controller-B7oD15Kt.js";const F=s=>C.test(s),T=()=>{const s=document.querySelector(".scroll-up-btn");s&&(window.addEventListener("scroll",()=>{window.scrollY>300?s.classList.add("show"):s.classList.remove("show")}),s.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}))},c=document.getElementById("loader");function E(){c&&c.classList.add("is-active")}function y(){c&&c.classList.remove("is-active")}const M=()=>{const s=document.querySelector("[data-burger-modal]"),e=document.querySelector(".site-menu-button");if(!s||!e)return;const t=f(s);e.addEventListener("click",()=>{t.open()})};class A{async getQuote(){return b()}}class I{constructor(e){i(this,"quoteText");i(this,"quoteAuthor");this.root=e,this.quoteText=this.getElement('[data-role="quote-text"]'),this.quoteAuthor=this.getElement('[data-role="quote-author"]')}renderQuote(e,t){this.quoteText.textContent=e,this.quoteAuthor.textContent=t}renderError(){this.quoteText.textContent="Unable to load the quote of the day.",this.quoteAuthor.textContent=""}getElement(e){const t=this.root.querySelector(e);if(!t)throw new Error(`Element not found: ${e}`);return t}}class ${constructor(e,t){this.model=e,this.view=t}async init(){try{const{quote:e,author:t}=await this.model.getQuote();this.view.renderQuote(e,t)}catch(e){console.error("Error loading quote of the day:",e),this.view.renderError()}}}let a=document.querySelector(".hero-title-icon");a.style.transform="scale(1)";a.style.transition="color 0.3s ease, transform 0.3s ease";let v=["#FFD54A","#FF9F1C","#FF6B6B","#A855F7","#38BDF8","#9BE15D","#FFD54A"],h=0;a.addEventListener("mouseover",function(){a.style.color=v[h],a.style.transform="scale(1.5) rotate(145deg)"});a.addEventListener("mouseout",function(){a.style.transform="scale(1) rotate(0deg)",a.style.color="var(--color-ink)",h=(h+1)%v.length});const H="favorite-exercises-list";class R{getFavorites(){const e=localStorage.getItem(H);if(e===null)return null;try{const t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}}}const D="It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future.";class N{constructor(e){i(this,"list");this.root=e,this.list=this.getElement(".favor-exercises-list")}renderEmptyState(){this.root.classList.add("favor-exercises-noitems");const e=document.createElement("p");e.className="favor-exercises-text",e.textContent=D,this.list.append(e)}getElement(e){const t=this.root.querySelector(e);if(!t)throw new Error(`Element not found: ${e}`);return t}}class B{constructor(e,t){this.model=e,this.view=t}init(){const e=this.model.getFavorites();(!e||e.length===0)&&this.view.renderEmptyState()}}const U=12,P=10;class _{constructor(){i(this,"state",{selectedFilter:o.MUSCLES,selectedCategory:null,keyword:"",categories:[],exercises:[]})}getState(){return this.state}async loadCategories(e){const t=await x({filter:e,page:1,limit:U});return this.state={...this.state,selectedFilter:e,selectedCategory:null,keyword:"",categories:t.results,exercises:[]},this.state}async selectCategory(e){return this.state={...this.state,selectedCategory:e,keyword:""},this.loadExercises()}async searchExercises(e){return this.state={...this.state,keyword:e.trim()},this.loadExercises()}async loadExercises(){if(!this.state.selectedCategory)return this.state;const e=await S(this.buildExercisesParams());return this.state={...this.state,exercises:e.results},this.state}buildExercisesParams(){const e={keyword:this.state.keyword,page:1,limit:P};switch(this.state.selectedFilter){case o.BODY_PARTS:e.bodypart=this.state.selectedCategory;break;case o.EQUIPMENT:e.equipment=this.state.selectedCategory;break;case o.MUSCLES:default:e.muscles=this.state.selectedCategory;break}return e}}class Q{constructor(e){i(this,"searchContainer");i(this,"searchForm");i(this,"searchInput");i(this,"exercisesSlash");i(this,"selectedCategoryText");i(this,"listContainer");i(this,"categoriesContainer");this.root=e,this.searchContainer=this.getElement("[data-exercises-search]"),this.searchForm=this.getElement("[data-exercises-search] .search-form"),this.searchInput=this.getElement("[data-exercises-search] .search-input"),this.exercisesSlash=this.getElement("[data-exercises-slash]"),this.selectedCategoryText=this.getElement("[data-exercises-selected-category]"),this.listContainer=this.getElement("[data-exercises-list]"),this.categoriesContainer=this.getElement("[data-exercises-categories]")}renderExerciseCategories(){this.categoriesContainer.innerHTML=Object.values(o).map(e=>`
    ...
    `}getCategoryFromEvent(e){const t=this.getClosestElement(e,"[data-category-name]");return(t==null?void 0:t.dataset.categoryName)??null}getClosestElement(e,t){return e instanceof HTMLElement?e.closest(t):null}getElement(e){const t=this.root.querySelector(e);if(!t)throw new Error(`Element not found: ${e}`);return t}formatDisplayName(e){return e.charAt(0).toUpperCase()+e.slice(1)}escapeHtml(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}}class V{constructor(e,t){this.model=e,this.view=t}async init(){this.view.renderExerciseCategories(),this.bindEvents(),this.view.setActiveFilter(o.MUSCLES),await this.loadCategories(o.MUSCLES)}bindEvents(){this.view.onFilterClick(e=>{this.loadCategories(e)}),this.view.onCategoryCardClick(e=>{this.selectCategory(e)}),this.view.onSearchSubmit(e=>{this.searchExercises(e)}),this.view.onSearchClear(()=>{this.searchExercises("")})}async loadCategories(e){await this.runRequest(()=>this.model.loadCategories(e))}async selectCategory(e){await this.runRequest(()=>this.model.selectCategory(e))}async searchExercises(e){await this.runRequest(()=>this.model.searchExercises(e))}async runRequest(e){this.view.setLoading(!0);try{await e(),this.render()}catch(t){this.view.renderError(t)}finally{this.view.setLoading(!1)}}render(){const e=this.model.getState();if(this.view.setActiveFilter(e.selectedFilter),e.selectedCategory){this.view.renderExercises(e);return}this.view.renderCategoryCards(e.categories)}}class O{constructor(e,t){this.model=e,this.view=t}init(){this.bindEvents(),this.view.enableSubmit()}bindEvents(){this.view.onSubscribe(e=>{this.handleSubscription(e)})}async handleSubscription(e){if(!e){n("Email is required",l.Error);return}if(!F(e)){n("Please enter a valid email address.",l.Error);return}const r={email:e};await this.runRequest(()=>this.model.subscribe(r))}async runRequest(e){this.view.setLoading(!0),E();try{const t=await e();n(t.message,l.Success),this.view.resetForm()}catch(t){const r=k(t);n(r,l.Error)}finally{this.view.setLoading(!1),y()}}}class j{async subscribe(e){return L(e)}}class G{constructor(e){i(this,"emailInputElement");i(this,"subscribeButtonElement");this.root=e,this.emailInputElement=this.getElement("#subscribe-email"),this.subscribeButtonElement=this.getElement('#subscribe-form button[type="submit"]')}getElement(e){const t=this.root.querySelector(e);if(!t)throw new Error(`Element not found: ${e}`);return t}onSubscribe(e){this.root.addEventListener("submit",t=>{t.preventDefault(),e(this.getEmailInputValue())})}getEmailInputValue(){return this.emailInputElement.value.trim()}resetForm(){this.root.reset()}setLoading(e){this.emailInputElement.disabled=e,this.subscribeButtonElement.disabled=e}enableSubmit(){this.subscribeButtonElement.disabled=!1}}q();T();M();const d=document.querySelector("[data-favorites]");d&&new B(new R,new N(d)).init();const u=document.querySelector("[data-quote]");u&&new $(new A,new I(u)).init();const m=document.querySelector("[data-exercises-section]");m&&new V(new _,new Q(m)).init();const g=document.querySelector("[data-subscribe-form]");g&&new O(new j,new G(g)).init();E();y();
//# sourceMappingURL=main-iTA0Efhg.js.map
