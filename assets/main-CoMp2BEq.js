var h=Object.defineProperty;var d=(s,e,t)=>e in s?h(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t;var i=(s,e,t)=>d(s,typeof e!="symbol"?e+"":e,t);import{f as u,e as g,E as a,g as m,c as y,i as v}from"./rating.controller-Bi4KEJIB.js";const C=()=>{const s=document.querySelector(".scroll-up-btn");s&&(window.addEventListener("scroll",()=>{window.scrollY>300?s.classList.add("show"):s.classList.remove("show")}),s.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}))},o=document.getElementById("loader");function w(){o&&o.classList.add("is-active")}function E(){o&&o.classList.remove("is-active")}const p=()=>{const s=document.querySelector("[data-burger-modal]"),e=document.querySelector(".site-menu-button");if(!s||!e)return;const t=u(s);e.addEventListener("click",()=>{t.open()})};class f{async getQuote(){return g()}}class x{constructor(e){i(this,"quoteText");i(this,"quoteAuthor");this.root=e,this.quoteText=this.getElement('[data-role="quote-text"]'),this.quoteAuthor=this.getElement('[data-role="quote-author"]')}renderQuote(e,t){this.quoteText.textContent=e,this.quoteAuthor.textContent=t}renderError(){this.quoteText.textContent="Unable to load the quote of the day.",this.quoteAuthor.textContent=""}getElement(e){const t=this.root.querySelector(e);if(!t)throw new Error(`Element not found: ${e}`);return t}}class S{constructor(e,t){this.model=e,this.view=t}async init(){try{const{quote:e,author:t}=await this.model.getQuote();this.view.renderQuote(e,t)}catch(e){console.error("Error loading quote of the day:",e),this.view.renderError()}}}const k="favorite-exercises-list";class b{getFavorites(){const e=localStorage.getItem(k);if(e===null)return null;try{const t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}}}const L="It appears that you haven't added any exercises to your favorites yet. To get started, you can add exercises that you like to your favorites for easier access in the future.";class q{constructor(e){i(this,"list");this.root=e,this.list=this.getElement(".favor-exercises-list")}renderEmptyState(){this.root.classList.add("favor-exercises-noitems");const e=document.createElement("p");e.className="favor-exercises-text",e.textContent=L,this.list.append(e)}getElement(e){const t=this.root.querySelector(e);if(!t)throw new Error(`Element not found: ${e}`);return t}}class T{constructor(e,t){this.model=e,this.view=t}init(){const e=this.model.getFavorites();(!e||e.length===0)&&this.view.renderEmptyState()}}const M=12,F=10;class ${constructor(){i(this,"state",{selectedFilter:a.MUSCLES,selectedCategory:null,keyword:"",categories:[],exercises:[]})}getState(){return this.state}async loadCategories(e){const t=await m({filter:e,page:1,limit:M});return this.state={...this.state,selectedFilter:e,selectedCategory:null,keyword:"",categories:t.results,exercises:[]},this.state}async selectCategory(e){return this.state={...this.state,selectedCategory:e,keyword:""},this.loadExercises()}async searchExercises(e){return this.state={...this.state,keyword:e.trim()},this.loadExercises()}async loadExercises(){if(!this.state.selectedCategory)return this.state;const e=await y(this.buildExercisesParams());return this.state={...this.state,exercises:e.results},this.state}buildExercisesParams(){const e={keyword:this.state.keyword,page:1,limit:F};switch(this.state.selectedFilter){case a.BODY_PARTS:e.bodypart=this.state.selectedCategory;break;case a.EQUIPMENT:e.equipment=this.state.selectedCategory;break;case a.MUSCLES:default:e.muscles=this.state.selectedCategory;break}return e}}class H{constructor(e){i(this,"searchContainer");i(this,"searchForm");i(this,"searchInput");i(this,"exercisesSlash");i(this,"selectedCategoryText");i(this,"listContainer");i(this,"categoriesContainer");this.root=e,this.searchContainer=this.getElement("[data-exercises-search]"),this.searchForm=this.getElement("[data-exercises-search] .search-form"),this.searchInput=this.getElement("[data-exercises-search] .search-input"),this.exercisesSlash=this.getElement("[data-exercises-slash]"),this.selectedCategoryText=this.getElement("[data-exercises-selected-category]"),this.listContainer=this.getElement("[data-exercises-list]"),this.categoriesContainer=this.getElement("[data-exercises-categories]")}renderExerciseCategories(){this.categoriesContainer.innerHTML=Object.values(a).map(e=>`
